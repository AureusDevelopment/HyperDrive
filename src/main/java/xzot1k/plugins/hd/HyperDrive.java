...
public class HyperDrive extends JavaPlugin {
    ...
    private void updateConfigs() {
        ...
        boolean isOffhandVersion = Ref.isNewerThan(8)/*getServerVersion().startsWith("v1_8_")*/;
                ...
                if (name.equalsIgnoreCase("config")) {
                    ...
                    if (isOffhandVersion) {
                        if (teleportationSound == null || teleportationSound.equalsIgnoreCase("ENDERMAN_TELEPORT")) {
                            if (Ref.isNewerThan(8) && Ref.isOlderThan(13)/* getServerVersion().toLowerCase().startsWith("v1_12_") || getServerVersion().toLowerCase().startsWith("v1_11_")
        ...
        for (String key : configurationSection.getKeys(true)) {
            ...
            if (key.toLowerCase().startsWith("global-sounds")) {
                ...
                if (keyValue != null) {
                    ...
                    if (Ref.isNewerThan(8)&&Ref.isOlderThan(13)/*getServerVersion().startsWith("v1_12_") || getServerVersion().startsWith("v1_9_")
                    ...
                    } else if (Ref.isOlderThan(7)/*getServerVersion().startsWith("v1_8_")*/) {
                ...
                if (keyValue != null)
                    switch (keyValue.toUpperCase().replace(" ", "_").replace("-", "_")) {
                        case "INK_SAC":
                            if (Ref.isNewerThan(12)/*getServerVersion().startsWith("v1_13_")*/) {
                                yaml.set(key, "ROSE_RED");
                                updateCount++;
                            } else if (Ref.isNewerThan(8) && Ref.isOlderThan(13)/* getServerVersion().startsWith("v1_12_") || getServerVersion().startsWith("v1_9")
                                    || getServerVersion().startsWith("v1_11_") || getServerVersion().startsWith("v1_10_")*/) {
                            ...
                            break;
                        case "INK_SACK":
                            if (Ref.isNewerThan(7)/*getServerVersion().startsWith("v1_8_")*/) {
                                yaml.set(key, "INK_SAC");
                                updateCount++;
                            } else if (Ref.isNewerThan(12)/*getServerVersion().startsWith("v1_13_")*/) {
                                yaml.set(key, "ROSE_RED");
                                updateCount++;
                            } else {
                                yaml.set(key, "RED_DYE");
                            ...
                            break;
                        case "ROSE_RED":
                            if (Ref.isNewerThan(8)&&Ref.isOlderThan(13)/* !getServerVersion().startsWith("v1_13_") && (getServerVersion().startsWith("v1_12_")
                                    || getServerVersion().startsWith("v1_9_") || getServerVersion().startsWith("v1_11_")
                                    || getServerVersion().startsWith("v1_10_"))*/)
                                yaml.set(key, "INK_SACK");
                            else if (Ref.isNewerThan(7)/*getServerVersion().startsWith("v1_8_")*/)
                                yaml.set(key, "INK_SAC");
                        ...
                        case "RED_DYE":
                            if (Ref.isNewerThan(12)/*getServerVersion().startsWith("v1_13_")*/) {
                                yaml.set(key, "ROSE_RED");
                                updateCount++;
                            } else if (Ref.isNewerThan(8)&&Ref.isOlderThan(13)/*getServerVersion().startsWith("v1_12_") || getServerVersion().startsWith("v1_9_")
                                    || getServerVersion().startsWith("v1_11_") || getServerVersion().startsWith("v1_10_")*/) {
                                yaml.set(key, "INK_SACK");
                                updateCount++;
                            } else if (Ref.isNewerThan(7)/*getServerVersion().startsWith("v1_8_")*/) {
                            ...
                            break;
                        case "CLOCK":
                            if (Ref.isNewerThan(7) && Ref.isOlderThan(13)/*getServerVersion().startsWith("v1_12_") || getServerVersion().startsWith("v1_11_") || getServerVersion().startsWith("v1_10_")
                            ...
                            break;
                        case "WATCH":
                            if (Ref.isNewerThan(12)/*!(getServerVersion().startsWith("v1_12_") || getServerVersion().startsWith("v1_11_") || getServerVersion().startsWith("v1_10_")
                                    || getServerVersion().startsWith("v1_9_") || getServerVersion().startsWith("v1_8_"))*/) {
                                yaml.set(key, "CLOCK");
                                updateCount++;
                            }
